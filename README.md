...
- **Languages & Stack:** Python, Flask, React, Next.js, OpenAI API, MongoDB  
- **Highlights:**  
  - Automated document parsing  
  - AI-generated summaries and resource suggestions  
...
- **Languages & Stack:** JavaScript, React, Node.js, Socket.io, MongoDB  
- **Highlights:**  
  - Real-time meeting scheduling and notifications  
...
- **Languages & Stack:** Python, Scikit-learn, Pandas, Flask, Plotly Dash, PostgreSQL  
- **Highlights:**  
  - Streamlined ML pipeline for anomaly detection  
  - Interactive dashboards for transaction monitoring  
...
- Passionate about **AI-driven solutions, scalable web platforms, and full-stack engineering**  
- Focused on **clean architecture, modular code, and real-world impact**  
- Constantly exploring **Reinforcement Learning, ML Ops, and system optimization**  
